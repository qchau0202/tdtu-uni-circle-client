            ...
            <div className="flex-1 space-y-3">
              <div className="space-y-2">
                <div className="flex flex-wrap items-center gap-2">
                  <h1 className="text-3xl font-bold text-[#141414]">{profileInfo.name}</h1>
              ...
              {profileInfo.bio && (
                <p className="text-base text-gray-600 max-w-2xl leading-relaxed">{profileInfo.bio}</p>
              )}
              <div className="flex flex-wrap gap-2">
                {profileInfo.focusAreas.map((area) => (
                  <Badge
                    key={area}
                    variant="outline"
                    className="border-gray-200 text-sm font-medium px-3 py-1"
                  >
                    {area}
                  </Badge>
                ))}
